...
import {getDefaultHeadImg, getGenderStr, uploadFile, getSpeciesMemo, getSterilizationMemo} from '../../../util/tool'
...
export default class PetUpdate extends Component {
  ...
  componentWillMount () { 
    ...
    Httpclient.get(
      ...
      .then(res => {
        ...
        console.log("获取到的头像信息是" + res.Data.headImg)
        this.setState({
          petDetail: res.Data,
  ...
  commit = (e) =>{
    ...
    if (errMsgMap != null && errMsgMap.size != 0) {
      ...
      if (this.state.headImgRechoose) {
        this.setState({
          uploading: true
        })
        uploadFile(this.state.headImg, this.updatePet)
        this.setState({
          uploading: false
        })
      } else {
